---
title: "Auditing election results via Twitter with sentiment analysis"
author: "Khizer Asad"
...
```{r tweets, echo=FALSE, fig.align="center", out.width= "85%"}
...
```{r users, echo=FALSE, fig.align="center", out.width= "85%"}
...
knitr::include_graphics('GB3.png')
```
...
```{r echo=FALSE, fig.align="center", out.width= "85%"}
knitr::include_graphics('GB4.png')
```
...
knitr::include_graphics('GB5.png')
```
